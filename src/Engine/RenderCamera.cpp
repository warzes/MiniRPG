...
//-----------------------------------------------------------------------------
void RenderCamera::Teleport(const glm::vec3 & pos)
{
...
//-----------------------------------------------------------------------------
void RenderCamera::Teleport(const glm::vec3& pos, const glm::vec3& forwardLook)
{
	position = pos;
	target = pos + forwardLook;
}
//-----------------------------------------------------------------------------
void RenderCamera::MoveBy(float distance)
{
...
//-----------------------------------------------------------------------------
void RenderCamera::StrafeBy(float distance)
{
...
//-----------------------------------------------------------------------------
void RenderCamera::RotateLeftRight(float angleInDegrees)
{
...
//-----------------------------------------------------------------------------
void RenderCamera::RotateUpDown(float angleInDegrees)
{
...
//-----------------------------------------------------------------------------
glm::vec3 RenderCamera::GetNormalizedViewVector() const
{
...
//-----------------------------------------------------------------------------
glm::vec3 RenderCamera::GetForwardVector() const
{
	return GetNormalizedViewVector();
}
//-----------------------------------------------------------------------------
glm::vec3 RenderCamera::GetRightVector() const
{
...
//-----------------------------------------------------------------------------
glm::vec3 RenderCamera::GetUpVector() const
{
#ifndef GLM_FORCE_LEFT_HANDED
	glm::vec3 forwardVector = GetForwardVector();
